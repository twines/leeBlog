...
func webRouter() {
	...
	webRouter.GET("/category/:id.html", web.Index)
	webRouter.GET("/blog/detail/:id.html", web.BlogDetail)
	webRouter.GET("/login", web.LoginIndex)
	webRouter.POST("/login", web.LoginPost)
	webRouter.GET("/register", web.RegisterIndex)
	webRouter.POST("/register", web.RegisterPost)
